...
const Index = () => {
  ...
  const partners = [
    { name: "StartupTN", logo: "src/assets/1.png" },
    { name: "Aakam360", logo: "src/assets/1.png" },
    { name: "Aakam Shine", logo: "src/assets/1.png" },
    { name: "Sponsor One", logo: "src/assets/1.png" },
      ...
      <section className="bg-secondary/20 py-16 md:py-24">
        <div className="container max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8">
            {[
              { val: "16", label: "Teams", bgColor: "bg-primary", textColor: "text-primary-foreground" },
              { val: "30+", label: "Matches", bgColor: "bg-accent", textColor: "text-accent-foreground" },
